...
class _home extends State<Home> {
  ...
  int _selectedIndex = 0;   //used to identify the selected page
...
Row(
    children: <Widget>[
                  const Align(
                    ...
                    child: Text("  Mina ",style: TextStyle(fontSize: 30,color: Colors.black),),
                  ),
Container(width: 90),
     Container(
                    height: 90 ,
                    width: 90,
                    child: Image.asset("assets/product_imgs/logo.png"),
                  ),
]),
                  SizedBox(
              ...
              SizedBox(height: 30,),
              Text('Tips',   style: TextStyle(fontSize: 24.0,) ),

          ExpansionTile(
            title: Text('soil?',   style: TextStyle(fontSize: 24.0,) ),
            ...
            children: const [
              // Add your tip of the day content here
              Text('Good soil is essential for your plants.',  style: TextStyle(fontSize: 24.0,)),
            ],
          ),
              ExpansionTile(
                title: Text('process?',   style: TextStyle(fontSize: 24.0,) ),
                onExpansionChanged: (value) {
                  setState(() {
                    _expanded = value;
                  });
                ...
                children: const [
                  ...
                  Align(
                    alignment: Alignment.centerLeft,
                  child: Text('\t\tEnjoy the process.',  style: TextStyle(fontSize: 24.0,) ),
                  ),
                ],
              ),
